# No interpreter information, as it is not meant to be run alone
...
# This module implements Observable and Observer elements of the Observer design pattern

"""
	Attribution: http://python-3-patterns-idioms-test.readthedocs.org/en/latest/Observer.html
"""
...
class Observer:
	...
	# I added a little correction to this code to include 'self', as it is an instance method
...
class Observable(Synchronization):
	def __init__(self):
		...
		#print("Observable - constructor " + str(self))
